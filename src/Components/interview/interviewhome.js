...
//     }
//   };
//   ///students names list from students databse

//   const fetchCompanytNames = async () => {
//     try {
...
//     }
//   };
// //company list from company databse 
...
//     }
//   }, [frequency, selectedDate]); // Add frequency and selectedDate as dependencies

//   useEffect(() => {
//     fetchStudentNames();
//     getAllStudentData();
//   }, [getAllStudentData]); // Include getAllStudentData in the dependency array
...
//   useEffect(() => {
//     getAllStudentData();
//   }, [frequency, selectedDate, getAllStudentData]); // Include getAllStudentData in the dependency array
...
//         <Select initialvalues="" style={{ width: 475 }}>
//           {companyNames.map((name, index) => (
//             <Select.Option  key={index} value={name}>{name}</Select.Option >
//           ))}
//         </Select>
//       </Form.Item>
//           <Form.Item label="Student" name="StudentName">
//             <Select initialvalues="" style={{ width: 475 }}>
